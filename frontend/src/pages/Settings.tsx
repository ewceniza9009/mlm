...
const Settings = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-12">
      ...
      {/* ADMIN SECTION */}
      {user?.role === 'admin' && (
        <div className="bg-slate-800 p-8 rounded-xl border border-teal-700 shadow-teal-900 shadow-lg">
          <div className="flex items-center gap-3 mb-6">
            <div className="bg-teal-600 w-2 h-8 rounded-full"></div>
            <h2 className="text-xl font-bold text-white">System Compensation Rules <span className="text-xs bg-teal-900 px-2 py-1 rounded text-teal-200 ml-2">ADMIN</span></h2>
          </div>
          ...
          <form onSubmit={handleSaveAdmin} className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <select
                ...
                className="w-full bg-slate-900 border border-slate-600 rounded-lg p-3 text-white focus:border-teal-500"
              >
      ...
      <div className="bg-slate-800 p-8 rounded-xl border border-slate-700">
        ...
        <form onSubmit={handleSaveProfile} className="space-y-6">
          ...
          <div className="pt-4 border-t border-slate-700">
            <button className="bg-slate-700 text-white px-6 py-2 rounded-lg hover:bg-slate-600 transition">
              Save Preferences
            </button>
          </div>
        </form>
