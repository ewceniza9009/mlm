        ...
        <div className="flex-1 bg-white dark:bg-slate-800 rounded-3xl shadow-sm border border-gray-100 dark:border-slate-700 p-6 md:p-8">
          ...
          <div className="flex p-1 bg-gray-100 dark:bg-slate-700/50 rounded-xl mb-6 w-full md:w-fit">
            <button
              ...
              className={`flex-1 md:flex-none px-6 py-2.5 rounded-lg text-sm font-bold transition-all shadow-sm ${activeTab === 'withdraw' ? 'bg-white dark:bg-slate-600 text-teal-600 dark:text-teal-400 shadow-md transform scale-100' : 'text-gray-500 dark:text-slate-400 hover:text-gray-700 dark:hover:text-slate-300 shadow-none'}`}
            >
              Request Payout
            </button>
            <button
              onClick={() => setActiveTab('transfer')}
              className={`flex-1 md:flex-none px-6 py-2.5 rounded-lg text-sm font-bold transition-all shadow-sm ${activeTab === 'transfer' ? 'bg-white dark:bg-slate-600 text-indigo-600 dark:text-indigo-400 shadow-md transform scale-100' : 'text-gray-500 dark:text-slate-400 hover:text-gray-700 dark:hover:text-slate-300 shadow-none'}`}
            >
              Transfer Funds
            </button>
          </div>
