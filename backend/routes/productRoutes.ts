...
import { createProduct, deleteProduct, getAllProducts, getShopProducts, getShopStatus, updateProduct, getPublicProducts, restockProduct, getWishlist, addToWishlist, removeFromWishlist } from '../controllers/productController';
