          ...
          <table className="w-full text-left text-gray-600 dark:text-slate-300">
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-slate-700">
              {wallet?.transactions.map((tx: any) => (
                <tr key={tx._id} className="hover:bg-gray-50 dark:hover:bg-slate-750">
                  ...
                  <td className={`px-6 py-4 font-mono font-medium ${tx.amount > 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
              ...
              {(!wallet?.transactions || wallet.transactions.length === 0) && (
                <tr>
                  <td colSpan={5} className="px-6 py-8 text-center text-gray-500 dark:text-slate-500">No transactions found.</td>
                </tr>
              )}
            </tbody>
          </table>
